...
FROM python:3.7.11-slim-stretch as deps
...
ARG BUILD_NUM
ARG SHA1
ENV MICROCOSM_LOGGING__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV MICROCOSM_LOGGING__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
